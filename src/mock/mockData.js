    ...
    content: [
        {
            ...
            imagen: process.env.PUBLIC_URL + "/img/productos/celular_opo.jpg",
            stock: 50,
        ...
        },
        {
            ...
            imagen: process.env.PUBLIC_URL + "/img/productos/laptop.jpg",
            stock: 20,
        ...
        },
        {
            ...
            precio_venta: 89.99,
            imagen: process.env.PUBLIC_URL + "/img/productos/camiseta_Alianza.jpg",
            stock: 100,
        ...
        },
        {
            ...
            nombre: "Sofá Moderno",
            precio_venta: 550.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/sofa_moderno.jpg",
            stock: 10,
        ...
        },
        {
            ...
            nombre: 'Tablet 10"',
            precio_venta: 850.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/tablet.jpg",
            stock: 15,
        ...
        },
        {
            ...
            nombre: 'Amazon Alexa',
            precio_venta: 850.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/amazon_alexa.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 120.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/buffers.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 420.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/Cama-Vari-II.jpg",
            stock: 15,
        ...
        },
        {
            ...
            imagen: process.env.PUBLIC_URL + "/img/productos/comedor_sillas.jpg",
            stock: 15,
        ...
        },
        {
            ...
            nombre: 'Ropero India',
            precio_venta: 400.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/ROPERO-INDIA.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 549.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/zapatera-de-melamina.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 359.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/Pantalon-cargo-de-montana.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 156.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/chaleco.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 248.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/polo.jpg",
            stock: 15,
        ...
        },
        {
            ...
            precio_venta: 248.00,
            imagen: process.env.PUBLIC_URL + "/img/productos/polera.jpg",
            stock: 15,
